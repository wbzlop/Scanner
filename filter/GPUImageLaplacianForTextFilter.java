...
/**
 * Created by wubaozeng on 2018/9/19.
 * Laplacian 滤波（martrix 针对文字处理,会有细节丢失）
 */

public class GPUImageLaplacianForTextFilter extends GPUImage3x3TextureSamplingFilter {
    ...
    public GPUImageLaplacianForTextFilter(final float lineSize) {
        this(new float[]{
                1, 1, 1,
                1, -8.0f, 1,
                1, 1, 1
    ...
    private GPUImageLaplacianForTextFilter(final float[] convolutionKernel) {
